...
class App {
  ...
  constructor(routes: Routes[], jobs: any[] = []) {
    this.app = express();
  ...
  public listen() {
    this.app.listen(this.port, () => {
      ...
      logger.info(`🚀 SYNC SERVER LISTENING ON PORT: ${this.port}`);
      logger.info(`=================================`);
    });
  }
  ...
  private initializeScheduler(jobs: any[] = []) {
    jobs.forEach(job => {
      job.start();
    });
  }
